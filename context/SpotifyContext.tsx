...
export const SpotifyProvider = ({ children }: any) => {
  ...
  const fetchPlaylists = async () => {
    try {
      ...
      console.log('(jason.corns) --------------------------------------- start group: const data = resp.data;');
      console.log('(jason.corns) logged details from ~/Sites/Next-spotify-main/context/SpotifyContext.tsx');
      const data = resp.data;
      console.log("(jason.corns) data", data);
      console.log('(jason.corns) ----------------------------------------- end group: const data = resp.data;');
